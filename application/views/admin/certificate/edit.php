          ...
          <div class="">
            ...
            <div class="page-title">
              <div class="title_left">
                <h3 style="color: #ff6600;">Certificates</h3>
              </div>              
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                     <form class="form form-horizontal" method="POST" action="<?=site_url('admin/certificate/update_data')?>" enctype="multipart/form-data">
                                  ...
                                  <div class="col-md-8">
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" value="<?=$certificate->certificate_title?>" name="title" class="form-control" placeholder="Banner Title" maxlength="250" required>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <select  name="status" class="form-control">
                                                <option value="Active" <?php if($certificate->certificate_status == 'Active'){?>selected<?php } ?> >Active</option>
                                                <option value="Blocked" <?php if($certificate->certificate_status == 'Blocked'){?>selected<?php } ?> >Blocked</option>
                                              </select>
                                            </div>
                                          </div>                                               
                                      </div>
                                    ...
                                    <div class="col-md-4">     
                                       ...
                                       <div id="current-image">
                                            <img src="<?=base_url() . $certificate->certificate_image?>" height="85px" width="100px">
                                       </div>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <button type="submit" class="btn btn-primary btn-rounded waves-light waves-effect w-md pull-right" id="submit-button">Update</button>
                                    </div>
                                </div>
                         </form>
                      </div>
