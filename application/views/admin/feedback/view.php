          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 style="color: #ff6600;">Feedback</h3>
              </div>
            </div>
                    ...
                    <table id="user_data" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th width="20%" style="border-color: #ff6600;">Customer Comments</th>
                          <th width="5%" style="border-color: #ff6600;">Number Of Stars</th>
              ...
              <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                      <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="<?=site_url('admin/feedback/update_data')?>" method="post">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var dataTable = $('#user_data').DataTable({
          ...
          "order":[],
          "ajax":{
            url:"<?=site_url('admin/feedback/get')?>",
            type:"POST"
          },
          "columnDefs":[
            {
