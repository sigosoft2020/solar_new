...
<div class="container">
    <div class="panel messages-panel">
                  ...
                  <!--   <form class="panel-search-form info form-group has-feedback no-margin-bottom">
                    ...
                    <div class="contacts-outter">
                        <ul class="list-unstyled contacts">
                           <li data-toggle="tab" data-target="#inbox-message-0" class="active">
                              <div class="vcentered info-combo">
                                 <h2 class="no-margin-bottom name">Chats </h2>
                              </div>
                           </li>
                          <?php foreach($users as $user) {?>
                            <li data-toggle="tab" data-target="#inbox-message-<?=$user->user_id?>" onclick="add('<?php echo $user->user_id; ?>')">
                              ...
                              <?php } else { }; ?>
                                ...
                                <div class="vcentered info-combo">
                                    <h3 class="no-margin-bottom name"><strong><?php echo $user->user_name;?></strong>  </h3>
                                    <h5> <?php echo @$user->last_mssg;?></h5>
                                </div>
                                <div class="contacts-add">
                                    <span class="message-time"> <?php echo @$user->last_time;?></span>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane message-body active" id="inbox-message-0">
                
            </div>
          
          <?php foreach($users as $user) {?>
            <div class="tab-pane message-body" id="inbox-message-<?=$user->user_id?>">
                
                <div class="message-chat">
                    <div class="chat-body">
                      <?php foreach($user->messages as $message) {?>
                        <?php if($message->user_type=='customer') {?>
                            <div class="message info">
                                ...
                                <div class="message-body">
                                    <div class="message-info">
                                        ...
                                        <h5> <i class="fa fa-clock-o"></i><?php echo date('d-M-y',strtotime($message->date));?>&nbsp;&nbsp;<?=$message->time?></h5>
                                    </div>
                                    <hr>
                    ...
                    <div class="chat-footer">
                     <form method="POST" action="<?=site_url('admin/chats/addchat')?>">
                        <input type="hidden" name="user_id" value="<?=$user->user_id?>">
                        <textarea class="send-message-text" name="message" id="message"></textarea>
...
.profile-main .profile-background {
  background-image: url('<?=base_url()?>images/samples/forest.png');
...
.contacts li > .info-combo {
 ...
 function add(id)
 {
   ...
   $.ajax({
            url: "<?php echo base_url('admin/chats/status_change'); ?>", // complete url from siteurl/constroller/function
            method: 'POST',                       
             data:
                  {
                      user_id: user_id
