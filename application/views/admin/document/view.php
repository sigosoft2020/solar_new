   ...
   <?php if (isset($message)){ ?>
    ...
    <?php if (isset($error)){ ?>
        <div class="alert alert-danger additional">
          <strong>Oops</strong> Data already exists
        </div>
    <?php } ?>
                    ...
                    <table id="user_data" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th width="10%" style="border-color: #ff6600;">Type</th>
                          <th width="20%" style="border-color: #ff6600;">File</th>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var dataTable = $('#user_data').DataTable({
          ...
          "order":[],
          "ajax":{
            url:"<?=site_url('admin/documents/get')?>",
            type:"POST"
          },
          "columnDefs":[
            {
