            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                       <form class="form form-horizontal" method="POST" action="<?=site_url('admin/documents/insert_data')?>" enctype="multipart/form-data">
                               <div class="row">
                                  <div class="col-md-6">
                                      <div class="">
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Document Title</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" name="title" class="form-control" placeholder="Document Title" maxlength="250" required>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                         ...
                                         <div class="form-group" style='display:none;' id='add_image'>
                                           ...
                                           <div class="form-group" style='display:none;' id='add_video'>
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Video link</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                 <input type="text" class="form-control" name="video" id="video" maxlength="250">
                                              </div>
                                          </div>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <button type="submit" class="btn btn-primary btn-rounded waves-light waves-effect w-md pull-right" id="submit-button">Add</button>
                                    </div>
                                </div>
                             </form>
                          </div>
