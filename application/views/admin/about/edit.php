          ...
          <div class="">
            ...
            <div class="page-title">
              <div class="title_left">
                <h3 style="color: #ff6600;">About Solar Now</h3>
              </div>              
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                       <form class="form form-horizontal" method="POST" action="<?=site_url('admin/about/update_data')?>" enctype="multipart/form-data">
                              <input type="hidden" name="abt_id" value="<?=$abt->ab_id?>">
                               <div class="row">
                                  <div class="col-md-6">
                                      <div class="">
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" value="<?=$abt->title?>" name="title" class="form-control" placeholder="Banner Title" maxlength="250" required>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea type="text" name="description" class="form-control" placeholder="Description" rows="4" cols="50" required><?=$abt->description?></textarea>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <select  name="status" class="form-control">
                                                <option value="Active" <?php if($abt->status == 'Active'){?>selected<?php } ?> >Active</option>
                                                <option value="Blocked" <?php if($abt->status == 'Blocked'){?>selected<?php } ?> >Blocked</option>
                                              </select>
                                            </div>
                                          </div>                                               
                                      </div>
                                    ...
                                    <div class="col-md-6">     
                                       ...
                                       <div id="current-image">
                                            <img src="<?=base_url() . $abt->image?>" height="290px" width="440px">
                                       </div>
