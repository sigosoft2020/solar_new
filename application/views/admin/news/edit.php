            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                     <form class="form form-horizontal" method="POST" action="<?=site_url('admin/news/update_data')?>" enctype="multipart/form-data">
                                  ...
                                  <div class="col-md-6">
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text"  value="<?=$news->title?>" name="title" class="form-control" placeholder="News Title" maxlength="250" required>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea type="text" name="description" class="form-control" placeholder="Description" rows="4" cols="50" required><?=$news->description?></textarea>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <select  name="status" class="form-control">
                                                <option value="Active" <?php if($news->status == 'Active'){?>selected<?php } ?> >Active</option>
                                                <option value="Blocked" <?php if($news->status == 'Blocked'){?>selected<?php } ?> >Blocked</option>
                                              </select>
                                            </div>
                                          </div>                                               
                                      </div>
                                    ...
                                    <div class="col-md-6">     
                                       ...
                                       <div id="current-image">
                                            <img src="<?=base_url() . $news->image?>" height="250px" width="450px">
                                       </div>
