            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                      <form class="form form-horizontal" method="POST" action="<?=site_url('admin/banners/update_data')?>" enctype="multipart/form-data">
                                  ...
                                  <div class="col-md-4">
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title</label>
                                              <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" value="<?=$banner->banner_title?>" name="title" class="form-control" placeholder="Banner Title" maxlength="100" required>
                                              </div>
                                          </div>
                                          <br>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <select  name="status" class="form-control">
                                                <option value="Active" <?php if($banner->banner_status == 'Active'){?>selected<?php } ?> >Active</option>
                                                <option value="Blocked" <?php if($banner->banner_status == 'Blocked'){?>selected<?php } ?> >Blocked</option>
                                              </select>
                                            </div>
                                          </div>                                               
                                      </div>
                                    ...
                                    <div class="col-md-8">     
                                       ...
                                       <div id="current-image">
                                            <img src="<?=base_url() . $banner->banner_image?>" height="290px" width="440px">
                                       </div>
