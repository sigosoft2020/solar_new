                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="user_data" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th width="2%" style="border-color: #ff6600;">Product Id</th>
                          <th width="10%" style="border-color: #ff6600;">Title</th>
                          <th width="20%" style="border-color: #ff6600;">Description</th>
                          <th width="10%" style="border-color: #ff6600;">Image</th>
                          <th width="2%" style="border-color: #ff6600;">Status</th>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var dataTable = $('#user_data').DataTable({
          ...
          "order":[],
          "ajax":{
            url:"<?=site_url('admin/how_to_use/get')?>",
            type:"POST"
          },
          "columnDefs":[
            {
